...
//自定义常量
//公共目录地址
defined('__PUBLIC__') OR define('__PUBLIC__', 'http://localhost/newMis/newMis/public/user/');
//defined('__PUBLIC__') OR define('__PUBLIC__', 'http://user_public.ispa.local/user/');
defined('PHOTO_DOMAIN') OR define('PHOTO_DOMAIN', 'http://localhost/newMis/newMis/public/user');
//defined('PHOTO_DOMAIN') OR define('PHOTO_DOMAIN', 'http://shop.ispa.cn');
...
defined('SMS_MAX_TIMES_BY_IP') OR define('SMS_MAX_TIMES_BY_IP', 20);//在一段时间内同一个ip最多能发送的短信次数
