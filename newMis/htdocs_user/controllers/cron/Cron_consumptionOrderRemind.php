...
/**
     * 消费订单提醒 
     */
class Cron_consumptionOrderRemind extends Cron_Controller
{
	
	private static $key = 'consumptionOrderRemind';
	...
	/**
	     * 执行入口
	     * 命令行执行  cd /appRoot && /alidata/server/php/bin/php index.php cron cron_consumptionOrderRemind index
	     * @param 
	     * @return return_type
	...
	protected function run()
	{
		...
		while (1) {
			$result = $this->order_remind_service->oneConsumptionOrderRemind();
