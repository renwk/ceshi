<?php
class Event_recharge_mycard_model extends CI_Model{
	...
	public function add($id, $userId, $uuid, $mycardId, $ucardOrderId, $fullMoney, $trueMoney)
	{
		...
		return $this->db->insert('u_event_recharge_mycard', $data);
	}
	...
	public function updateState($id, $toState)
	{
		...
		$this->db->where('id', $id);
		return $this->db->update('u_event_recharge_mycard', $data);
