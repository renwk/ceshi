...
//  $config['base_url'] = 'http://www.dh.com/'; //开发使用 stest.ispa.cn
$config['base_url'] = 'http://userapi.ispa.local/';
//$config['base_url'] = 'http://localhost/newMis/newMis/htdocs_shop';
...
$config['sess_save_path'] = 'E:\wamp\www\newMis\newMis\htdocs_userapi\sessions'; //开发使用
