...
Page({
  ...
  delTag:function (data) {
    var that = this;
    var url = "http://api.ispa.local/api/Usercard/delTag";
  ...
  mytaginfo:function (data) { //会员标签
    var that = this;
    var url = "http://api.ispa.local/api/Usercard/mytaginfo";
    app.post(url, data).then((res) => {
      console.log(res);
      that.setData({
        usertag: res.usertag,
  ...
  addtag: function (data) { //添加护理日志
    var that = this;
    var url = "http://api.ispa.local/api/Usercard/addtag";
    app.post(url, data).then((res) => {
      console.log(res)
      that.setData({
        msg:res
  ...
  upContent: function (data) { //添加护理日志
    var that = this;
    var url = "http://api.ispa.local/api/Usercard/upContent";
    app.post(url, data).then((res) => {
      console.log(res)
      that.setData({
        msg: res
  ...
  upremark: function (data) { //护理汇总
    var that = this;
    var url = "http://api.ispa.local/api/Usercard/upremark";
    app.post(url, data).then((res) => {
      that.setData({
        msg: res
      }, function () {
  ...
  gettag: function (data) { //会员标签
    var that = this;
    var url = "http://api.ispa.local/api/Usercard/gettag";
    app.post(url, data).then((res) => {
      console.log(res);
      that.setData({
        tags:res
